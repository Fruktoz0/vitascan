...
import { bodyApi, getErrorMessage } from '../services/api';
...
export default function BodyPartLogPage() {
  ...
  const [items, setItems] = useState<
    Array<{ id: string; valueCm: number; loggedDate: string; deltaCm: number | null }>
  >([]);
      ...
      <div className={`${styles.content} ${styles.contentStack}`}>
        ...
        <div className={styles.statsRow}>
          ...
          <div className={styles.statCard}>
            ...
            <div className={styles.statValue} style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
